...
void cs123x_task_handle(void)
{
    if(cs123x_comps.sw._bit.adc_updated)
    {
        ...
        {
            cs123x_comps.write_reg(&device_comps.ad1_convert_result[device_comps.ad1_pos++],0x71);
            cs123x_comps.current_channel++;
            cs123x_comps.enable_interrupt();
        }
        else if(cs123x_comps.current_channel==1)
        {
            cs123x_comps.write_reg(&device_comps.deltaP_p_convert_result[device_comps.deltaP_p_pos++],0x70);
