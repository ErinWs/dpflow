...
void display_Total(int index)
{
    ...
    if(hum_comps.dis_extern_oper_mark._bit.refresh_total)
    {
		...
		hum_comps.dig3_6=num/1000000%10;
		hum_comps.dig3_7=num/10000000%10;
		hum_comps.dig3_8=num/100000000%10;
        hum_comps.dot3_pos=device_comps.dpf_param.Td;///////////////////////
        if(device_comps.dpf_param.Fu==0)//kg/h
        {
            MD_DIS_T6_KG;
        }
        ...
        MD_DIS_T1_TOTAL;
        hide_zero(&hum_comps.dig3_5,6,hum_comps.dot0_pos+1);
