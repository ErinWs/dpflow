...
#define SET_CLEAR()		P7.0=1//GP4DAT = (GP4DAT | 0x00040000)	//P4.2->CLEAR
#define CLR_CLEAR()		P7.0=0//GP4DAT = (GP4DAT & 0xFFFBFFFF)

#define SET_LATCH()		P3.1=1//GP4DAT = (GP4DAT | 0x00080000)	//P4.3->LATCH
#define CLR_LATCH()		P3.1=0//GP4DAT = (GP4DAT & 0xFFF7FFFF)

#define	SET_SCL()		P6.2=1//GP4DAT = (GP4DAT | 0x00100000)	//P4.4->SCLK
#define	CLR_SCL()		P6.2=0//GP4DAT = (GP4DAT & 0xffefffff)

#define SET_SDO()		P6.1=1//GP4DAT = (GP4DAT | 0x00200000)	//P4.5->SDIN
#define CLR_SDO()		P6.1=0//GP4DAT = (GP4DAT & 0xffdfffff)
...
{
	"ad54x0 r/w driver",//char desc[32];
