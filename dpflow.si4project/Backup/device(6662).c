...
insert_calc:
    {
        ...
        k =(long)(
        ((long long) (delta_p-LowTValue)*(device_comps.dpf_param.k[Top]-device_comps.dpf_param.k[Bottom]))
        /(HighTValue - LowTValue)
        )
        +device_comps.dpf_param.k[Bottom];
    }
ret:
    {
        float p;
