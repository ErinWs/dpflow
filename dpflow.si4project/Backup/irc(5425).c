		  ...
		  #elif (MD_PRODUCT_NAME==MD_NORMAL)
		  {
			...
			case MD_DATA_ID_WRITE_CAL_DATA:       //write cal data       
    			...
    			else 
    			{
                   ...
                   else if(device_comps.cal_type==EM_CAL_DELTAP)
                   {
                        switch(buf[13])
                        {
                            ...
                            case 3:     
                                        ...
                                        device_comps.deltaP_calibration_param_bak.dot=cal_param_dot_bak;;
                                        device_comps.deltaP_calibration_param_bak.unit=cal_param_unit_bak;
                                        ...
                                        if(device_comps.save_calibration_param(&device_comps.deltaP_calibration_param_bak,sizeof(device_comps.deltaP_calibration_param_bak)))
                        				{
                        				    ircMisc.send_buf[i]=(buf[9]|0x90);
                                            mode_comps[hum_comps.current_mode].dis_option=0;
                                            hum_comps.dis_oper_mark._bit.refresh_option=1;
                   ...
                   else else if(device_comps.cal_type==EM_CAL_RES)
                   {
                        switch(buf[13])
                        {
                            case 0:
                            ...
                            case 1:
                                        ...
                                        device_comps.res_calibration_param_bak.dot=cal_param_dot_bak;;
                                        device_comps.res_calibration_param_bak.unit=cal_param_unit_bak;
                                        ...
                                        if(device_comps.save_deltaP_calibration_param(&device_comps.res_calibration_param_bak,sizeof(device_comps.res_calibration_param_bak)))
                        				{
                        				    ircMisc.send_buf[i]=(buf[9]|0x90);
                                            mode_comps[hum_comps.current_mode].dis_option=0;
                                            hum_comps.dis_oper_mark._bit.refresh_option=1;
