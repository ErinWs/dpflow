...
static void MD_DISPLAY_WRITE_D4_0(unsigned char a)  //  D02  H   L 
 {
     MD_15_PIN_LCD_SEG17&=0xf8;
     MD_15_PIN_LCD_SEG17|=hum_comps.SEG_TAB[a]>>4;
     MD_16_PIN_LCD_SEG18&=0xf0;
 ...
 static void MD_DISPLAY_WRITE_D4_1(unsigned char a)  //  D03  H   L 
 {
     MD_17_PIN_LCD_SEG19&=0xf0;
     MD_17_PIN_LCD_SEG19|=hum_comps.SEG_TAB[a]>>4;
 ...
 static void MD_DISPLAY_WRITE_D4_2(unsigned char a)//  D04  H   L  
 {
     ...
     MD_12_PIN_LCD_SEG11|=hum_comps.SEG_TAB[a]&0x0f;
                  ...
                  //  D10  H   L  
  static void  MD_DISPLAY_WRITE_D4_3(unsigned char a)   
  {
     MD_11_PIN_LCD_SEG08&=0xf0;
     MD_11_PIN_LCD_SEG08|=hum_comps.SEG_TAB[a]>>4;
  ...
  static void MD_DISPLAY_WRITE_D4_4(unsigned char a)  //  D00  H   L 
  {
      MD_09_PIN_LCD_SEG06&=0xf8;
      MD_HIDE_P10_DOT;
      MD_09_PIN_LCD_SEG06|=hum_comps.SEG_TAB[a]>>4;
  ...
  static void MD_DISPLAY_WRITE_D4_5(unsigned char a)//  D01  H   L 
  {
  ...
  static void MD_DISPLAY_WRITE_D4_6(unsigned char a)//  D04  H   L  
   {
       ...
       MD_12_PIN_LCD_SEG11|=hum_comps.SEG_TAB[a]&0x0f;
                    ...
                    //  D10  H   L  
    static void  MD_DISPLAY_WRITE_D4_7(unsigned char a)   
    {
       MD_11_PIN_LCD_SEG08&=0xf0;
       MD_11_PIN_LCD_SEG08|=hum_comps.SEG_TAB[a]>>4;
       if(hum_comps.dot3_pos==3)  MD_11_PIN_LCD_SEG08|=0x08;
    ...
    static void MD_DISPLAY_WRITE_D4_8(unsigned char a)  //  D00  H   L 
    {
        MD_09_PIN_LCD_SEG06&=0xf8;
        MD_HIDE_P10_DOT;
        MD_09_PIN_LCD_SEG06|=hum_comps.SEG_TAB[a]>>4;
    ...
    static void MD_DISPLAY_WRITE_D4_9(unsigned char a)//  D01  H   L 
    {
...
void display_cal_adc_on_line4(cal_type_t cal_type)
{
   int stb=1;
   int refresh=0;
   long num=0;
...
void display_deltaP(int index)
{
    ...
    {
        long num=device_comps.current_deltaP;
        if(num<0)
    	{
    	    num=-num;
    	    hum_comps.dig3_5=MD_HIDE_DISP-1;
...
static void lcd_test(hum_comps_t *const this)
{
    void (*p[])(unsigned char dig)={ MD_DISPLAY_WRITE_D0_0,MD_DISPLAY_WRITE_D0_1,MD_DISPLAY_WRITE_D0_2,MD_DISPLAY_WRITE_D0_3,MD_DISPLAY_WRITE_D0_4,MD_DISPLAY_WRITE_D0_5,
	                                 ...
	                                 MD_DISPLAY_WRITE_D4_6,MD_DISPLAY_WRITE_D4_7,MD_DISPLAY_WRITE_D4_8,MD_DISPLAY_WRITE_D4_9};  
    if(this->count%2==0)
    {
        int k=this->count/2;
        if(k<6)
...
static void cal_modify_mode_display(unsigned char opt)
{
    ...
    if(device_comps.cal_type==EM_CAL_PRESS)
    {
        display_cal_adc_on_line4(EM_CAL_PRESS);
        if(hum_comps.dis_oper_mark._bit.refresh_cal_param)
        {
            hum_comps.dig2_0=device_comps.calibration_param.y[opt]%10;
            hum_comps.dig2_1=device_comps.calibration_param.y[opt]/10%10;
    ...
    else if(device_comps.cal_type==EM_CAL_PRESS)
    {
            display_temp_adc();
