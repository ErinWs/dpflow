...
ret:
    {
        ...
        if(device_comps.dpf_param.bT==0)//other jiezhi
        {
            ...
            {
                float A1=device_comps.dpf_param.A[0]%10000000/fpwr(device_comps.dpf_param.A[0]/10000000%10);
                float A2=device_comps.dpf_param.A[1]%10000000/fpwr(device_comps.dpf_param.A[1]/10000000%10);
