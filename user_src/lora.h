#ifndef LORA_H
#define LORA_H
#define  MD_LORA_AUX_PIN          P13_bit.no7
#define  MD_LORA_EN_PIN           P2_bit.no0
#define  MD_LORA_EN_PIN_RESET     P2_bit.no0=0
#define  MD_LORA_EN_PIN_SET       P2_bit.no0=1
#define  MD_LORA_SET_PIN_RESET    P2_bit.no2=0
#define  MD_LORA_SET_PIN_SET      P2_bit.no2=1
